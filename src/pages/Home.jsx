  ...
  return (
    ...
    <div>
      ...
      <div className="main-text-area">
        <h3>
          Navigate Campus in seconds.
        </h3>
        <p>Scan QR Code near you or Search for any building hall or department name to get instant turn-by-turn directions. </p>
      </div>
      ...
      <div className="nav-page">
        ...
        {!isNavigating && !arrived && (
          <div className="location-section">
                  ...
                  {!showScanner ? (
                    ...
                    <div className="scanner-container">
                      <div className="scanner-header">
                        <span><i class="ri-qr-scan-2-line"></i> Scanning...</span>
            ...
            >
              {loading ?
                <i class="ri-loader-2-line"> Finding path...</i> :
                <i class="ri-route-line"> Find Path</i>}
            </button>
        ...
        {isNavigating && route && !arrived && (
          <div className="nav-view">
            ...
            <div className="mode-switch">
              ...
              >
                <i class="ri-direction-line"></i> Path
              </button>
              <button
                className={navigationMode === 'ar' ? 'active' : ''}
                onClick={() => setNavigationMode('ar')}
              >
                <i class="ri-arrow-up-circle-fill"></i> AR Arrow
              </button>
            </div>
              ...
              <div className="text-directions">
                <div className="route-header">
                  <span className="route-from">
                    {/*  ;location pin icon*/}
                    <i class="ri-map-pin-line"></i> {route.from}
                  </span>
                  ...
                  <span className="route-to">
                    {/* location pin icon */}
                    <i class="ri-map-pin-add-fill"></i> {route.to}
                  </span>
                </div>
